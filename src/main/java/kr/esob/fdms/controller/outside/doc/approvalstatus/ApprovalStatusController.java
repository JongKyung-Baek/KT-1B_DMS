...
@Controller
@RequestMapping("/outside/doc/approvalStatus")
public class ApprovalStatusController extends AbstractController {
	...
	public String home(Model model, CommonHomeParam param) throws JsonProcessingException {
		...
		model.addAttribute("formInfo", JSONArray.fromObject(formService.selectFormInfo("formOutsideDocApprovalStatus")));
		model.addAttribute("toolbarInfo", JSONArray.fromObject(toolbarService.selectToolbarInfo("toolbarOutsideDocApprovalStatus")));
		model.addAttribute("gridInfo", JSONArray.fromObject(gridService.selectGridInfo("gridOutsideDocApprovalStatusList")));

		return "outside/doc/approvalStatus/approvalStatusList";
	}
	...
	public String destroyStatusPopup(Model model, DestroyStatusParam param) throws JsonProcessingException {
		...
		model.addAttribute("popupInfo", new ObjectMapper().writeValueAsString(ApprovalStatusPopupInfo.DOC));
