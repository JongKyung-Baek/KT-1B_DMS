...
@Controller
@RequestMapping("/outside/unregisted/accept")
public class AcceptController extends AbstractController {
	...
	public String home(Model model, CommonHomeParam param) throws JsonProcessingException {
		...
		model.addAttribute("formInfo", JSONArray.fromObject(formService.selectFormInfo("formOutsideUnregistedAccept")));
		model.addAttribute("toolbarInfo", JSONArray.fromObject(toolbarService.selectToolbarInfo("toolbarOutsideUnregistedAccept")));
		model.addAttribute("gridInfo", JSONArray.fromObject(gridService.selectGridInfo("gridOutsideUnregistedAcceptList")));
		return "outside/unregisted/accept/acceptList";
	}
