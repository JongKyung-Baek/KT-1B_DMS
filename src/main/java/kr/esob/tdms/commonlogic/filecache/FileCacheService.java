package kr.esob.tdms.commonlogic.filecache;
...
public class FileCacheService {
    ...
    private String resolveCacheRootPath() {
        ...
        if (rootPath == null || rootPath.trim().isEmpty()) {
            rootPath = new File(System.getProperty("java.io.tmpdir"),
                    "kt1b-tdms/viewer-cache").getPath();
        }
        return rootPath;
    }
    ...
    private String resolveViewerEsobRootPath() {
        ...
        if (root == null || root.trim().isEmpty()) {
            root = new File(System.getProperty("java.io.tmpdir"),
                    "kt1b-tdms/viewer-output").getPath();
        }
        return root;
    }
