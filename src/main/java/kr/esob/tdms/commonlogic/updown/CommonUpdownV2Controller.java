...
import kr.esob.tdms.commonlogic.updown.runtime.DownloadRuntimeCleanupScheduler;
...
public class CommonUpdownV2Controller {
    ...
    public @ResponseBody Map<String, Object> start(@RequestBody CommonUpdownV2StartParam param, Authentication authentication) {
        ...
        try {
            ...
            if (updatedState == null
                    ...
                    != kr.esob.tdms.commonlogic.updown.runtime.DownloadRuntimeStatus.SENT_TO_WS
    ...
    public @ResponseBody Map<String, Object> status(@RequestBody CommonUpdownV2SeqParam param,
        ...
        result.put("errorMessage", state.getStatus() == kr.esob.tdms.commonlogic.updown.runtime.DownloadRuntimeStatus.FAILED
    ...
    private boolean isTerminal(DownloadRuntimeState state) {
        return state != null
                && (state.getStatus() == kr.esob.tdms.commonlogic.updown.runtime.DownloadRuntimeStatus.COMPLETED
                || state.getStatus() == kr.esob.tdms.commonlogic.updown.runtime.DownloadRuntimeStatus.FAILED);
    }
