...
/* import kr.esob.tdms.commonlogic.distactlog.DistributionActLogDao;
import kr.esob.tdms.commonlogic.distactlog.DistributionActLogParam; */
import org.springframework.stereotype.Service;

import kr.esob.tdms.commonlogic.updown.runtime.DownloadRuntimeState;
import kr.esob.tdms.commonlogic.filecache.ExternalFileApiClient;
...
public class CommonUpdownV2Service {
    ...
    public boolean saveDownloadAudit(Object userObj, DownloadRuntimeState state, String status, String errorMessage) {
        try {
            if (!(userObj instanceof kr.esob.tdms.controller.login.UserVO)) {
                return false;
            }
            kr.esob.tdms.controller.login.UserVO userVo = (kr.esob.tdms.controller.login.UserVO) userObj;
