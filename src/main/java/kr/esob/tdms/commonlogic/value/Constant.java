...
public class Constant {
	...
	public static final String DISTRIBUTION_APPROVAL_URL = "/general/distribution/approval/";
	public static final String DISTRIBUTION_ACCEPTANCE_URL = "/general/distribution/acceptance/";
	public static final String DISTRIBUTION_DISPOSAL_ACCEPTANCE_URL = "/general/distribution/disposalacceptance/";
	public static final String DISTRIBUTION_PRINT_APPROVAL_URL = "/general/distribution/printApproval/";
	public static final String DISTRIBUTION_PRINT_HISTORY_URL = "/general/distribution/printHistory/";
	...
	public static final String CR_APPROVAL_URL = "/general/cr/approval/";
	public static final String PRODUCT_APPROVAL_URL = "/general/production/approval/";
	public static final String PRODUCT_STATUS_URL = "/general/production/requeststatus/";
	public static final String PRODUCT_ACCEPT_URL = "/general/production/acceptance/";
	public static final String PRODUCT_DISPOSAL_APPROVAL_URL = "/general/production/disposalApproval/";
	public static final String PRODUCT_PRINT_APPROVAL_URL = "/general/production/approval/";
	public static final String PRODUCT_PRINT_STATUS_URL = "/general/production/requeststatus/";
