...
import kr.esob.tdms.controller.general.distribution.acceptance.AcceptancePopupListService;
import kr.esob.tdms.controller.general.distribution.drawingrequest.DrawingPopupRequestService;
import kr.esob.tdms.controller.general.distribution.drawingrequest.DrawingRequestParam;
import kr.esob.tdms.controller.general.distribution.drawingrequest.DrawingRequestService;
...
@Controller
@RequestMapping("/general/distribution/commonRequest")
...
//		model.addAttribute("purchaseTeam", purchaseTeamCombo);
		...
		return "/general/distribution/commonRequest/commonRequestPopup";
	}

	@RequestMapping(value="/approvalStatusPopup", method={RequestMethod.GET, RequestMethod.POST})
	public String approvalStatusPopup() {
		return "/general/distribution/commonRequest/approvalStatusPopup";
	}
...
//		}
		...
		return "/general/distribution/commonRequest/commonPrintRequestPopup";
	}
	...
	public String protectPopup(CommonDistributionRequestParam param, Model model) throws JsonProcessingException {
		...
		return "/general/common/protectPopup";
	}
...
//		model.addAttribute("customerRevision", nextCustomerRevision);
		...
		if (uri.contains("drawingRevisionUpdatePopup")) {
			return "general/distribution/drawingRevisionUpdatePopup";
		} else if(uri.contains("productionRevisionUpdatePopup")){
			return "general/distribution/production/productRevisionUpdatePopup";
		} else if(uri.contains("dxfRevisionUpdatePopup")){
			return "general/distribution/dxf/dxfRevisionUpdatePopup";
		} else{
			return "general/distribution/drawingRevisionUpdatePopup";	// 우선 도면 리비전 갱신 뷰 반환
		}
	...
	public String commonVersionCheckPopup(CommonDistributionRequestParam param, Model model, HttpServletRequest request) throws JsonProcessingException {
		...
		return "/general/distribution/drawingVersionCheckPopup";
	}
