...
@Controller
@RequestMapping("/general/distribution/dxfRequest")
public class DxfRequestController extends AbstractController {
	...
	public String home(Model model, CommonHomeParam param) throws JsonProcessingException {
		...
		return "/general/distribution/dxf/dxfRequestList";
	}
	...
	public String dxfFilePopup(DxfRequestParam param, Model model) {
		...
		return "general/distribution/dxf/dxfFilePopup";
	}
...
//		model.addAttribute("distributeType",distributeType);
		...
		return "general/distribution/dxf/dxfRegisterPopup";
	}
