 ...
 */
@Controller
@RequestMapping("/general/distribution/history")
public class HistoryController extends AbstractController {
	...
	public String home(Model model, CommonHomeParam param) throws JsonProcessingException {
		...
		return "/general/distribution/history/historyList";
	}
	...
	public String stopDealPopup(Model model) throws JsonProcessingException {
		...
		return "/general/distribution/history/stopDealPopup";
	}
	...
	public String destroyPopup(DestroyPopupParam param, Model model) throws JsonProcessingException {
		...
		return "/general/distribution/history/destroyPopup";
	}
