...
@Controller
@RequestMapping("/general/distribution/printDestroyApproval")
public class PrintDestroyApprovalController extends AbstractController {
	...
	public String home(Model model, CommonHomeParam param) throws JsonProcessingException {
		...
		return "general/distribution/printDestroyApproval/printDestroyApprovalList";
	}
...
//		model.addAttribute("listCount", service.selectPopupListCount(param));
		return "general/distribution/printDestroyApproval/printDestroyApprovalPopup";
	}
