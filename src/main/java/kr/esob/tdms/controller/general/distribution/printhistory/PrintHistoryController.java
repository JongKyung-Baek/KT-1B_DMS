package kr.esob.tdms.controller.general.distribution.printhistory;
...
@Controller
@RequestMapping("/general/distribution/printHistory")
public class PrintHistoryController extends AbstractController {
	...
	public String home(Model model, CommonHomeParam param) throws JsonProcessingException {
		...
		model.addAttribute("formInfo", JSONArray.fromObject(formService.selectFormInfo("formPrintHistory")));
		model.addAttribute("toolbarInfo", JSONArray.fromObject(toolbarService.selectToolbarInfo("toolbarPrintHistory")));
		model.addAttribute("gridInfo", JSONArray.fromObject(gridService.selectGridInfo("gridPrintHistoryList")));

		return "general/distribution/printHistory/historyList";
	}
	...
	public String disposalRequestPopup(printHistoryPopupParam param, Model model, HttpServletRequest request) throws JsonProcessingException {
...
//		*/
		...
		return "general/distribution/printHistory/disposalRequestPopup";
	}
