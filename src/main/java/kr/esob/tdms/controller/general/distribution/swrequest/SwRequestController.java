...
import kr.esob.tdms.controller.general.distribution.docrequest.DocRegisterPopupParam;
...
import kr.esob.tdms.commonlogic.toolbar.ToolbarInfoVO;
...
@Controller
@RequestMapping("/general/distribution/swRequest")
public class SwRequestController extends AbstractController {
	...
	public String home(Model model, CommonHomeParam param) throws JsonProcessingException {
		...
		return "/general/distribution/swRequestList";
	}
	...
	public String dashboard(Model model, CommonHomeParam param) {
		...
		return "/general/distribution/swDashboard";
	}
	...
	public String registerPopup(SwRegisterPopupParam param, Model model) {
		...
		return "general/distribution/swRegisterPopup";
	}
	...
	public String regist(SwRegisterPopupParam param, Model model) {
		...
		return "general/distribution/swRegisterPage";
	}
