...
@RequestMapping("/general/organizationmanage/insidedept")
@Controller
public class InsidedeptController extends AbstractController {
    ...
    public String home(Model model) throws JsonProcessingException {
        ...
        return "general/organizationmanage/insidedept/insidedeptList";
    }
    ...
    public String registerDept(Model model ,DeptPopupParam param) throws JsonProcessingException {
        ...
        return "general/organizationmanage/insidedept/registerDeptPopup";
    }
