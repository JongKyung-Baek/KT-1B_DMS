...
@RequestMapping("/general/organizationmanage/insideuser")
@Controller
public class InsideuserController extends AbstractController {
	...
	public String home(Model model) throws JsonProcessingException {
		...
		return "general/organizationmanage/insideuser/insideuserList";
	}
...
//		model.addAttribute("distributionAuthCd", comboDao.selectComboListByCd("distributionAuthCd"));
		...
		return "general/organizationmanage/insideuser/registerUserPopup";
	}
