...
@Controller
@RequestMapping(value="/general/production/productionstatus")
public class ProductionStatusController extends AbstractController {
	...
	public String home(Model model, CommonHomeParam param) throws JsonProcessingException {
		...
		return "general/production/productionstatus/statusList";
	}
	...
	public String requestPopup(Model model, CommonParam param) {
		...
		return "general/production/productionstatus/requestPopup";
	}
	...
	public String distributionHistoryPopup(Model model, DistributionHistoryVO param) {
		...
		return "/general/production/productionstatus/distributionHistoryPopup";
	}
