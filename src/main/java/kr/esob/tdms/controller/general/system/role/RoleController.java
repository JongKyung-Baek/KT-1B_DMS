...
import kr.esob.tdms.controller.general.system.menu.MenuService;
...
@Controller
@RequestMapping("/general/system/role")
public class RoleController extends AbstractController {
	...
	@RequestMapping("/")
	public String general(Model model, CommonHomeParam param) throws JsonProcessingException {
		...
		return "general/system/role/roleSide";
	}
	...
	public String addGroupPopup(Model model, RequestParam param, HttpServletRequest request) throws JsonProcessingException {
		...
		return "general/system/role/rolePopup";
	}
