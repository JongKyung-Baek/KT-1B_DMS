...
p(){var
c,d=a(s).jqGrid("getDataIDs"),e=a("#id_g",A).val();if(s.p.multiselect&&b[s.p.id].eddocselected){for(var
...
b.ruleGroup?a.jgrid.parse(b.ruleGroup):b.ruleGroup,h.rules&&h.rules.length)for(c=h.rules,d=0;d<c.length;d++)e=c[d],a.inArray(e.filed,b.ssfield)&&(f=e.data.split(b.spldocselect),f.length>1&&(void
...
c=a.jgrid.getRegional(this[0],"search");return b=a.extend({autosearch:!0,autosearchDelay:500,searchOnEnter:!0,beforeSearch:null,afterSearch:null,beforeClear:null,afterClear:null,onClearSearchValue:null,url:"",stringResult:!1,groupOp:"AND",defaultSearch:"bw",searchOperators:!1,resetIcon:"x",spldocselect:",",groupOpSelect:"OR",errorcheck:!0,operands:{eq:"==",ne:"!",lt:"<",le:"<=",gt:">",ge:">=",bw:"^",bn:"!^",in:"=",ni:"!=",ew:"|",en:"!@",cn:"~",nc:"!~",nu:"#",nn:"!#",bt:"..."}},c,b||{}),this.each(function(){var
...
s,t,u,v,w,x,y;if(k&&(s=a.jgrid.filterRefactor({ruleGroup:q,ssfield:l,spldocselect:b.spldocselect,groupOpSelect:b.groupOpSelect}),q=JSON.stringify(s)),m&&(a.isPlainObject(s)||(s=a.jgrid.parse(q)),s.rules&&s.rules.length))for(t=s.rules,u=0;u<t.length;u++)w=t[u],"bt"===w.op&&(x=w.data.split("..."),x.length>1&&(void
