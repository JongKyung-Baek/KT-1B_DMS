...
function fileUpload(){
    $('#drawingRegisFile').click();
}

function fileChange(){
    var fileName = $('#drawingRegisFile').val();
...
//     param.append('file', $("#drawingRegisFile")[0].files[0]);
//     param.append('formDrawingRegisterPopup', JSON.stringify($('#formDrawingRegisterPopup').serializeObject()));
//     console.log("뭐야 뭘 호출하는거야 ")
//     callAjaxUpload(param, "/general/distribution/drawingRequest/saveDrawingRegisterFile", requestCrCallback);
// }
