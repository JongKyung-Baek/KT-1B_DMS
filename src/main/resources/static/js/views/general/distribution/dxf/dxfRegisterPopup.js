...
function save(){
    ...
    param.append('file', $("#dxfRegisFile")[0].files[0]);
    param.append('formDxfRegisterPopup', JSON.stringify($('#formDxfRegisterPopup').serializeObject()));
    callAjaxUpload(param, "/general/distribution/dxfRequest/saveDxfRegisterFile", requestCrCallback);
}
