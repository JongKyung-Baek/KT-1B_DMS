...
function loadDxfRequestExplorerTree() {
	callAjax({}, "/general/distribution/dxfRequest/selectTree", function(response) {
...
function requestDistribute(){
	...
	if($("#"+gridId).getGridParam('selarrrow').length < 1){
		...
		openDialogPopup("/general/distribution/commonRequest/dxfRequestPopup", {protectYn: protectYn, requestType: requestType, approvalRequestType : "DISTRIBUTION"}, "popupDialog", 'l', 685, true, 'popup-common popup-request');
	}
}
