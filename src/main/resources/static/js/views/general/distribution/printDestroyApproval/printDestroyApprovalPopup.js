function setPopupGridParam(){
	popupGridParam = {
			...
			url : '/general/distribution/printDestroyApproval/selecDestroyApprovalList',
			pagerId : '',
			size : 9999,
			page : 1,
			multiSelect : true,
...
function saveDestroy(flag){
	...
	callAjax(param, '/general/distribution/printDestroyApproval/saveDestroyApproval', function(){
		if('A'==flag) {
