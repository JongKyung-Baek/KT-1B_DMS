...
function loadSwRequestExplorerTree() {
	callAjax({}, "/general/distribution/swRequest/selectTree", function(response) {
...
function searchAll(){
	openDialogPopup("/general/distribution/commonRequest/searchAllPopup", {type:'SW'}, "searchAllPopup", 's', 600);
}
