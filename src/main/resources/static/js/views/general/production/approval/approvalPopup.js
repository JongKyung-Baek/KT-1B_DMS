...
function setPopupRequestInfoGridParam(){
	popupRequestInfoGridParam = {
			...
			url : '/general/production/approval/selectRequestUserList',
			pagerId : '',
			size : 9999,
			page : 1,
			multiSelect : false,
...
function setPopupObjectInfoGridParam(){
	popupObjectInfoGridParam = {
			...
			formId : 'formApprovalInfoPopup',
			url : '/general/production/approval/selectObjectList',
			pagerId : '',
			size : 9999,
			page : 1,
			multiSelect : false,
...
function approval(flag){
	...
	callAjax(param, '/general/production/approval/approval', approvalCallback);
}
