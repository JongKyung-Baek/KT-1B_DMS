...
function setGridProductionParam(){
	...
	gridProductionParam = {
			...
			url: "/general/production/productionstatus/selectProductionReplace",
			numbering: false,
...
function runDeploy(param){
	callAjax(param, '/general/production/productionstatus/distributionRequest', requestCallback, 'json');
}
