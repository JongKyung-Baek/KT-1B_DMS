...
function setCheck(id){
	...
	initSelectRemoteData(selectId, "/general/authorization/selectJikUserComboList");
...
//	}
//	var rtn;
//	callAjax(param, "/general/authorization/selectDeptComboListByBusinessArea", function(response){
...
//	}
//	var rtn;
//	callAjax(param, "/general/authorization/selectJikUserComboList", function(response){
//		rtn = selectBoxCallback(response, options);
//	}, 'json', false);
//	return rtn;
...
function selectBoxChange(e){
	...
	callAjax({userCd: data.id}, '/general/authorization/selectDept', function(response) {
...
function deployRequest(){
	...
	$.each(ids, function(index, data){
		...
		$.each(ids2, function(index, data){
			...
			callAjax(param, '/general/production/request/selectDeployAcceptCheck', function(response){
				if(!response.success) {
					isSuccess=false;
...
function runDeploy(param){
	callAjax(param, '/general/production/request/distributionRequest', requestCallback, 'json');
}
