...
function loadFunction1() {
    callAjax({ manageType: currentManageType }, '/general/system/treemanage/function1/list', function (response) {
        function1 = response || [];
        renderFunction1List();
        loadFunction2();
    });
...
function loadFunction2() {
    ...
    callAjax({ parentTreeCd: selected1, manageType: currentManageType }, '/general/system/treemanage/function2/list', function (response) {
        function2 = response || [];
...
function loadDocTypes() {
    ...
    callAjax({ parentTreeCd: selected2, manageType: currentManageType }, '/general/system/treemanage/doctype/list', function (response) {
        docTypes = response || [];
...
function doDelete(treeCd, doneFn) {
    ...
    confirmMessage(treeManageMessage('feature.treeManage.confirm.delete', '선택한 항목을 삭제하시겠습니까?'), function () {
        ...
        callAjax({ treeCd: treeCd, manageType: currentManageType }, '/general/system/treemanage/node/delete', function (response) {
            if (response.success) {
