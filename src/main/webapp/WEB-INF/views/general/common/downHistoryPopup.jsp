...
<script>
    ...
    function setPopupGridParam(){
        popupGridParam = {
            ...
            url : '/general/distribution/downHistory/selectDownHistoryPopupList',
            size : 4,
            page : 1,
            multiSelect : false,
            numbering : false
    ...
    // function formatViewActLog(cellValue, options, rowdata, action){
    //     var redirectUrl = '/general/distribution/downHistory/actLogPopup?downloadedName=' + encodeURIComponent(rowdata["downloadedName"]);
