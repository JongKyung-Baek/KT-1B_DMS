...
<script>
	...
	function setGridParam(){
		gridParam = {
				...
				url : '/general/distribution/acceptance/selectList',
...
// 		}
	...
	function viewDetail(requestNo, objectType, statusCd, currentProcessSeqNo, businessTypeCd) {
		...
		openDialogPopup("/general/distribution/acceptance/approvePopup",{requestNo: requestNo, objectType : objectType, statusCd : statusCd, currentProcessSeqNo : currentProcessSeqNo, businessTypeCd : businessTypeCd}, "popupDialog", 'xl', popupHeight, true, 'popup-common popup-distribution-approval');
	}

	//생산기술자료 접수 팝업
	function viewProductDetail(requestNo) {
		openDialogPopup("/general/distribution/acceptance/productAcceptPopup",{requestNo: '20191104-P0002'}, "popupDialog", 'xl', 710);
	}
