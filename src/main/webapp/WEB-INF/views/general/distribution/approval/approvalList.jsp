...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/views/general/distribution/commonapproval/commonApproval.js"></script>
<script>
...
var formId = 'formDistributionApproval';
	...
	function setGridParam(){
		gridParam = {
				gridId : gridId,
				formId : formId,
				url : '/general/distribution/approval/selectList',
	...
	function viewDistributionApproval(requestNo, approvalLineId, currentProcessSeqNo, objectType){
		...
		openDialogPopup("/general/distribution/approval/approvalPopup", {requestNo: requestNo, approvalLineId: approvalLineId, currentProcessSeqNo: currentProcessSeqNo, objectType: objectType}, "popupDialog", 'l', popupHeight, true, 'popup-common popup-distribution-approval');
	}
	...
	function pass() {
		...
		openDialogPopup("/general/distribution/approval/passPopup", {requestNo: requestNo.join(',')}, "popupDialog", 's', 200);
	}
</script>
</head>
<body>
