...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/views/general/distribution/commonrequest/commonPrintRequestPopup.js"></script>
<!-- 출력 팝업 (출력승인요청 버튼) -->
<style>
