...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/views/general/distribution/commonrequest/commonRequestPopup.js"></script>
<style>
...
<div class="dialogContent commonRequestPopup popup-base popup-actions-center popup-type-upload-grid">
	...
	<form id="formRequest">
		...
		<ul class="section popupCard popupFormGrid popup-grid-4">
			<li>
				<%-- 업체 --%>
				<custom:popupSearchSelectBox options="${noSelect }" name="companyCd" label="form.company" searchUrl="/general/authorization/selectCompanyCombo" id="companyCd" />
			</li>
			<li>
				<%-- 업체 사용자 --%>
...
<%-- 				searchUrl="/general/authorization/selectPurchaseTeamCombo" id="purchaseTeam"/> --%>
