...
var formId = 'formDisposalAcceptance'
	function setGridParam(){
		gridParam = {
				gridId : gridId,
				formId : formId,
				url : '/general/distribution/disposalacceptance/selectList',
	...
	function viewDetail(destroyRequestNo) {
		openDialogPopup("/general/distribution/disposalacceptance/approvalPopup",{destroyRequestNo: destroyRequestNo}, "popupDialog", 'xl', 750, true, 'popup-common');
	}
