...
function loadApprovalStatus() {
    ...
    callAjax(
        ...
        "/general/distribution/docRequest/approveStatusRows",
        function (response) {
...
function saveApprovalComment(gridId, rowId) {
    ...
    callAjax(
        ...
        "/general/distribution/docRequest/saveApprovalComment",
        function (response) {
...
function downloadSelectedDocFile(gridId) {
    ...
    for (var i = 0; i < selectedRows.length; i++) {
        ...
        var url = "/general/distribution/docRequest/downloadFile?objectId=" + encodeURIComponent(data.objectId);
