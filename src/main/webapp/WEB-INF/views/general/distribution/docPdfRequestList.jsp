...
var gridId = 'gridDocPdfRequestList';
	function setGridParam(){
		gridParam = {
				...
				url : '/general/distribution/docPdfRequest/selectList',
...
function openDialog(objectId){
	openDialogPopup("/general/distribution/commonRequest/protectPopup", {objectId: objectId, objectType : "DOCPDF"}, "popupDialog", 'm', 360);
}
