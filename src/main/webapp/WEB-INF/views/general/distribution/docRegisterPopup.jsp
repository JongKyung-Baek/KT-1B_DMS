        ...
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
                ...
                <script type="text/javascript"
                    src="/resources/js/views/general/distribution/docRegisterPopup.js"></script>
                ...
                <script>
                    ...
                    function saveX() {
                        ...
                        callAjaxUpload(formData, "/general/distribution/docRequest/uploadDocRegisFile", requestCrXCallback);
                    }
                    ...
                    function initDocRegisterTreeSelectors() {
                        callAjax({}, "/general/distribution/docRequest/selectTree", function (response) {
                            var list = response || [];
                            var childrenMap = {};
                    ...
                    function updateDocNoPreview() {
                        ...
                        }, "/general/distribution/docRequest/nextDocNo", function (response) {
