...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/views/general/distribution/docRequestList.js"></script>
	<script>
		...
		function setGridParam() {
			gridParam = {
				...
				url: '/general/distribution/docRequest/selectList',
		...
		function openAnnotationDialog(objectId) {
			...
			openDialogPopup("/general/distribution/annotationinfo/annotationPopup", { objectId: objectId, objectType: "DOC" }, "popupDialog", 'xl', 400, true, 'popup-common popup-annotation');
		}
		//
		...
		function openDocFilePopup(objectId, documentNo, requestNo) {
			...
			openDialogPopup(
				"/general/distribution/docRequest/docFilePopup",
		...
		function upload() {
			...
			openDialogPopup("/general/distribution/docRequest/docRegisterPopup", {}, "popupDialog", 'l', popupHeight, true, 'popup-common popup-doc-register');
		}
		...
		function openDialog(objectId) {
			openDialogPopup("/general/distribution/commonRequest/protectPopup", { objectId: objectId, objectType: "DOC" }, "popupDialog", 'm', 360, true, 'popup-common popup-protect');
		}
		...
		function deleteDoc() {
			...
			confirmMessage(g_msg('msg.requestDelete'), function () {
				$(this).dialog("close");
				callAjax(param, "/general/distribution/docRequest/delete", deleteDocCallback, 'json');
			});
		}
		...
		function approveDocument() {
			...
			confirmMessage('승인하시겠습니까?', function () {
				$(this).dialog("close");
				callAjax(param, "/general/distribution/docRequest/approve", approveDocumentCallback, 'json');
			});
		}
