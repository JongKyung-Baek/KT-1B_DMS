    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
      <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
        ...
        <script type="text/javascript"
          src="/resources/js/views/general/distribution/drawingRequest/drawingRegisterPopup.js"></script>
        ...
        <script>
          ...
          function requestNextDrawingVersionNo() {
            ...
            callAjax(
              ...
              "/general/distribution/drawingRequest/nextVersionNo",
              function (response) {
          ...
          function initDrawingRegisterTreeSelectors() {
            callAjax({}, "/general/distribution/drawingRequest/selectTree", function (response) {
              var list = response || [];
              var childrenMap = {};
              var nodeMap = {};
              var normalizedNodes = [];
