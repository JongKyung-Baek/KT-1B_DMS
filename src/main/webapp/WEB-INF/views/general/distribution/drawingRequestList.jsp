	...
	<%@ taglib prefix="custom" tagdir="/WEB-INF/tags" %>
		<%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
			...
			<head>
				...
				<script type="text/javascript"
					src="${pageContext.request.contextPath}/resources/js/views/general/distribution/acceptance/common-form-vuexy.js"></script>
				<script type="text/javascript"
					src="${pageContext.request.contextPath}/resources/js/views/general/distribution/drawingRequest/drawingRequestList.js"></script>
				<script>
					...
					function setGridParam() {
						gridParam = {
							...
							url: '/general/distribution/drawingRequest/selectList',
					...
					function openDrawingFilePopup(objectId, drawingNo, requestNo) {
						...
						openDialogPopup(
							"/general/distribution/drawingRequest/drawingFilePopup",
					...
					function openAnnotationDialog(objectId) {
						openDialogPopup("/general/distribution/annotationinfo/annotationPopup", { objectId: objectId, objectType: "DRAWING" }, "popupDialog", 'xl', 400, true, 'popup-common popup-annotation');
					}
					...
					function upload() {
						...
						openDialogPopup("/general/distribution/drawingRequest/drawingRegisterPopup", {}, "popupDialog", 'l', popupHeight, true, 'popup-common popup-drawing-register');
					}
					...
					function openDialog(objectId) {
						openDialogPopup("/general/distribution/commonRequest/protectPopup", { objectId: objectId, objectType: "DRAWING" }, "popupDialog", 'm', 360, true, 'popup-common popup-protect');
					}
					...
					function deleteDrawing() {
						...
						confirmMessage(g_msg('msg.requestDelete'), function () {
							$(this).dialog("close");
							callAjax(param, "/general/distribution/drawingRequest/delete", deleteDrawingCallback, 'json');
						});
					...
					function approveDrawing() {
						...
						confirmMessage('승인하시겠습니까?', function () {
							$(this).dialog("close");
							callAjax(param, "/general/distribution/drawingRequest/approve", approveDrawingCallback, 'json');
						});
					}
