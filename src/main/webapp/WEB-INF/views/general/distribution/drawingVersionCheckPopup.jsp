...
<%--<script type="text/javascript" src="/resources/js/views/general/distribution/drawingRequest/drawingVersionCheckPopup.js"></script>--%>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/views/general/distribution/acceptance/approvalPopup.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/views/general/distribution/drawingRequest/drawingVersionCheckPopup.js"></script>
<!-- 배포 승인-->
<script>
    var popupGridParam;
...
// 	return '<a onclick="openFile(\''+ rowdata["filePath"] +'\')">'+cellValue+'</a>';
    ...
    function setPopupGridParam(){
        popupGridParam = {
            ...
            url : '/general/distribution/commonRequest/selectDrawingPopupList',
            pagerId : '',
            size : 9999,
            page : 1,
            shrinkToFit : false,
