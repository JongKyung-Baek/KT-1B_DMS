...
<script>
	...
	function loadApprovalStatus() {
		...
		callAjax(
			...
			"/general/distribution/dxfRequest/approveStatusRows",
			function (response) {
	...
	function saveApprovalComment(gridId, rowId) {
		...
		callAjax(
			...
			"/general/distribution/dxfRequest/saveApprovalComment",
			function (response) {
	...
	function downloadSelectedDxfFile(gridId) {
		...
		for (var i = 0; i < selectedRows.length; i++) {
			...
			var url = "/general/distribution/dxfRequest/downloadFile?objectId=" + encodeURIComponent(data.objectId);
