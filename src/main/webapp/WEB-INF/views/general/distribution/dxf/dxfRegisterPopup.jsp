...
<script type="text/javascript" src="/resources/js/views/general/distribution/dxf/dxfRegisterPopup.js"></script>
...
//                });
    ...
    function updateDxfNoPreview() {
        ...
        callAjax({
            levelNo: levelNo
        }, "/general/distribution/dxfRequest/nextDxfNo", function (response) {
