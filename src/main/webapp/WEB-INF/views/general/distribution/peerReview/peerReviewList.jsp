...
<script>
	...
	function setGridParam() {
		gridParam = {
			...
			url : '/general/distribution/peerReview/selectList',
	...
	function openPeerReviewFilePopup(objectId, peerReviewNo, requestNo) {
		...
		openDialogPopup(
			"/general/distribution/peerReview/peerReviewFilePopup",
	...
	function upload() {
		openDialogPopup("/general/distribution/peerReview/registerPopup", {}, "popupDialog", 'm', 320, true, 'popup-common');
	}
	...
	confirmMessage('검토하시겠습니까?', function () {
		$(this).dialog("close");
		callAjax(param, "/general/distribution/peerReview/approve", approvePeerReviewCallback, 'json');
	});
}
	...
	confirmMessage('철회하시겠습니까?', function () {
		$(this).dialog("close");
		callAjax(param, "/general/distribution/peerReview/delete", deletePeerReviewCallback, 'json');
	});
}
