...
var formId = "formPrintApproval";
	...
	function setGridParam(){
		gridParam = {
				gridId : gridId,
				formId : formId,
				url : '/general/distribution/printApproval/selectList',
	...
	function viewPrintApprovalPopup(requestNo, objectType){
		...
		openDialogPopup("/general/distribution/printApproval/approvePopup", {requestNo: requestNo, objectType: objectType}, "popupDialog", 'l', popupHeight, true, 'popup-common');
	}
