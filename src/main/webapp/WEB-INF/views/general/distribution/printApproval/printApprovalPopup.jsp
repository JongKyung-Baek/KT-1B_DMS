...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/views/general/distribution/printApproval/printApprovalPopup.js"></script>
...
function setPopupGridParam(){
	popupGridParam = {
			...
			url : '/general/distribution/approval/selecApprovalList',
			size : 9999,
			page : 1,
			multiSelect : false,
			numbering : false
