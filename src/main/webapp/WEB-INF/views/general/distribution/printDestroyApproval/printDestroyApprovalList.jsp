...
var formId = "formPrintDestroyApproval";
	function setGridParam(){
		gridParam = {
				gridId : gridId,
				formId : formId,
				url : '/general/distribution/printDestroyApproval/selectList',
	...
	function viewPrintDestroyApprovalPopup(destroyRequestNo){
		openDialogPopup("/general/distribution/printDestroyApproval/approvalPopup", {destroyRequestNo: destroyRequestNo}, "popupDialog", 'xl', 620, true, 'popup-common');
	}
	...
	function batchCall(saveType){
		...
		console.log(param);
		callAjax( param, "/general/distribution/printDestroyApproval/batchSaveApproval", batchCallback, 'json');
	}
