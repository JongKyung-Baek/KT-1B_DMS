...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/views/general/distribution/printDestroyApproval/printDestroyApprovalPopup.js"></script>
