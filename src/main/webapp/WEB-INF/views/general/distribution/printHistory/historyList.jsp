...
<script>
	function setGridParam(){
		gridParam = {
				...
				url : '/general/distribution/printHistory/selectList',
...
// 				}
			...
			if(isSuccess){
				openDialogPopup("/general/distribution/printHistory/disposalRequestPopup", {protectYn: protectYn, developmentProtectYn: developmentProtectYn, productProtectYn : productProtectYn}, "popupDialog", 'm', 550, true, 'popup-common');
			}
		}
	}
