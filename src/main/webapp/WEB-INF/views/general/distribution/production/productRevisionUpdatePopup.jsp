...
<script>
    ...
    function saveX() {
        ...
        formData.append("objectType", "PRODUCT");
        ...
        callAjaxUpload(  formData, "/general/distribution/productionRequest/uploadProductionRegisFile", requestCrXCallback);
    }
...
<div class="dialogContent">
    <form id="formDrawingRegisterPopup">
        <ul class="section">
            ...
            <%--자료명--%>
            <li>
                <custom:popupInputText name="dataName" id="dataName" label="form.dataName" value="${objectNm}"/>
            </li>
