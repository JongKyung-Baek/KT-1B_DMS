...
<script>
	...
	function loadApprovalStatus() {
		...
		callAjax(
			...
			"/general/distribution/productionRequest/approveStatusRows",
			function (response) {
	...
	function saveApprovalComment(gridId, rowId) {
		...
		callAjax(
			...
			"/general/distribution/productionRequest/saveApprovalComment",
			function (response) {
	...
	function downloadSelectedProductionFile(gridId) {
		...
		for (var i = 0; i < selectedRows.length; i++) {
			...
			var url = "/general/distribution/productionRequest/downloadFile?objectId=" + encodeURIComponent(data.objectId);
