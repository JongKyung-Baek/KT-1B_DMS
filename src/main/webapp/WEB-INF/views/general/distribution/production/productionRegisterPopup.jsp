...
<script type="text/javascript" src="/resources/js/views/general/distribution/production/productionRegisterPopup.js"></script>
...
//                });
    ...
    function updateProductionNoPreview() {
        ...
        callAjax({
            levelNo: levelNo
        }, "/general/distribution/productionRequest/nextProductionNo", function (response) {
