			...
			<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
				<%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
					...
					<head>
						...
						<script type="text/javascript"
							src="${pageContext.request.contextPath}/resources/js/views/general/distribution/production/productionRequestList.js"></script>
						<script>
							...
							function setGridParam() {
								gridParam = {
									...
									url: '/general/distribution/productionRequest/selectList',
							...
							function request() {
								...
								openDialogPopup('/general/distribution/productionRequest/requestPopup', {}, 'popupDialog', 'l', '800');
							}
							...
							function printRequest() {
								...
								openDialogPopup('/general/distribution/productionRequest/printRequestPopup', {}, 'popupDialog', 's', '330');
							}
							...
							function deletePrd() {
								...
								confirmMessage(g_msg('msg.requestDelete'), function () {
									$(this).dialog("close");
									callAjax(param, "/general/distribution/productionRequest/delete", deletePrdCallback, 'json');
								});
							}
							...
							function approvePrd() {
								...
								confirmMessage('승인하시겠습니까?', function () {
									$(this).dialog("close");
									callAjax(param, "/general/distribution/productionRequest/approve", approvePrdCallback, 'json');
								});
							}
							...
							function showPrdStatusDetail(rowId) {
								...
								openDialogPopup(
									"/general/distribution/commonRequest/approvalStatusPopup",
									{
										...
										approveUrl: "/general/distribution/productionRequest/approveStatusMessage",
				...
				true,
							...
							function openProductionFilePopup(objectId, objectNo, requestNo, objectType) {
								openDialogPopup(
									"/general/distribution/productionRequest/productionFilePopup",
