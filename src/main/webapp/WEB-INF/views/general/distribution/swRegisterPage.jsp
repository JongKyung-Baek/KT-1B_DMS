...
var IS_SW_REGISTER_PAGE = "<spring:escapeBody htmlEscape="false" javaScriptEscape="true">${swRegisterPageMode}</spring:escapeBody>" === "true";
                            ...
                            var SW_REMOVE_SUPPORTING_FILE_LABEL = swRegisterMessage(
                                "feature.techRegister.upload.removeFile",
                                "선택 파일 제거"
                            );
                            ...
                            function renderSwSubSelectedFiles() {
                                ...
                                files.forEach(function (file, index) {
                                    ...
                                    $('<i>', {
                                        'class': 'icon-base ti tabler-file',
                                        'aria-hidden': 'true'
                                    }).appendTo($item);
                                    $('<span>', {
                            ...
                            function updateSwNoPreview() {
                                ...
                                callAjax({
                                    levelNo: levelNo
                                }, "/general/distribution/swRequest/nextSwNo", function (response) {
                            ...
                            function requestCrXCallback(response) {
                                if (response && response.success) {
                                    ...
                                    infoMessage(response.message || swRegisterMessage(
                                        ...
                                        if (IS_SW_REGISTER_PAGE) {
                                            location.href = "/general/distribution/swRequest/";
                                            return;
                                        }
                                        try {
                            ...
                            <div class="dialogBtnSet">
                                ...
                                <div class="right">
                                    <button type="button" class="sw-register-list-button"
                                        onclick="location.href='${pageContext.request.contextPath}/general/distribution/swRequest/'">
                    ...
                    <script>
                        ...
                        function updateSwRegisterStatus() {
                            ...
                            var mainFile = mainFileInput && mainFileInput.files && mainFileInput.files.length
                                ...
                                : null;
                            var subFileCount = getSwAccumulatedSubFiles(subFileInput).length;
