...
<spring:message code="feature.organization.department.browserTitle" text="부서 관리" var="pageTitle"/>
<spring:message code="feature.organization.department.resultsAria" text="부서 검색 및 목록" var="resultsAria"/>
<!doctype html>
...
var formId = 'formInsideDept';
	...
	function setGridParam(){
		gridParam = {
				gridId : gridId,
				formId : formId,
				url : '/general/organizationmanage/insidedept/selectList',
	...
	function registerDept(){
		openDialogPopup("/general/organizationmanage/insidedept/registerDeptPopup", {}, "popupDialog", 's', 0, true, 'popup-common popup-inside-dept-register');
	}
	// 수정
	// function editDept(){
	// 	openDialogPopup("/general/organizationmanage/insidedept/editDeptPopup", {}, "popupDialog", 's', 360 );
	// }
	...
	function openDeptInfo(deptCd) {
		...
		openDialogPopup("/general/organizationmanage/insidedept/editDeptPopup", param, "popupDialog", 's', 0, true, 'popup-common popup-inside-dept-register');
	}
