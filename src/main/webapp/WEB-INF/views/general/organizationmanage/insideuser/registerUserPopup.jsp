...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/views/general/organizationmanage/insideuser/registerUserPopup.js"></script>
...
<%--            </li>--%>
            ...
            <%-- 팀 목록 --%>
            <li>
                <custom:popupSearchSelectBox name="deptCd" id="deptCd" options="${noSelect_dept}" searchUrl="/general/authorization/selectDeptCombo" label="form.deptNm" selectedValue="${info.deptCd }" selectedText="${info.deptNm }"/>
            </li>

            <%-- 역할 목록 --%>
            <li>
                <custom:popupSearchSelectBox name="positionCd" id="positionCd" options="${noSelect_position}" searchUrl="/general/authorization/selectPositionCombo" label="grid.positionNm" selectedValue="${info.positionCd }" selectedText="${info.positionNm }"/>
            </li>

            <%-- 사용자 권한 목록 --%>
            <li>
                <custom:popupSearchSelectBox name="roleGroupCd" id="roleGroupCd" options="${noSelect_roleGroup}" searchUrl="/general/authorization/selectRoleGroupCombo" label="form.roleGroup" selectedValue="${info.roleGroupCd }" selectedText="${info.roleGroupNm }"/>
            </li>

            <%-- 배포 권한 목록 --%>
            <!-- <li>
                <custom:popupSearchSelectBox name="distributionAuthCd" id="distributionAuthCd" options="${noSelect_distributionAuth}" searchUrl="/general/authorization/selectDistributionAuthCombo" label="form.distributionAuth" selectedValue="${info.distributionAuthCd }" selectedText="${info.distributionAuthNm }"/>
            </li> -->
