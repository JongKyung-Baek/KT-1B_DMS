...
<script>
	function setGridParam(){
		gridParam = {
				...
				url : '/general/production/acceptance/selectList',
...
// 		return '<a href="javascript: accept()">' + cellValue + '</button>';
	...
	function viewDetail(requestNo, objectId, objectType) {
		openDialogPopup("/general/production/acceptance/acceptancePopup", {requestNo: requestNo, objectId : objectId, objectType : objectType}, "popupDialog", 'l', 620);
	}
	...
	function accept(){
		if($("#gridProductionAcceptance").getGridParam('selarrrow').length < 1){
			...
			openDialogPopup("/general/production/acceptance/acceptancePopup", {list:JSON.stringify(aJsonArray)}, "popupDialog", 'l', 620);
		}
	}
</script>
</head>
