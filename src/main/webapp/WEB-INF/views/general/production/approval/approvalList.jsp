...
<script>
	...
	function setGridParam(){
		gridParam = {
				gridId : gridId,
				formId : formId,
				url : '/general/production/approval/selectList',
	...
	function viewDetail(requestNo, objectType, requestPurpose){
		if(requestPurpose == "NEW"){
			openDialogPopup("/general/production/approval/approvalPopup", {requestNo: requestNo, objectType: objectType}, "popupDialog", 'l', 725);
		}else{
			openDialogPopup("/general/production/approval/replaceApprovalPopup", {requestNo: requestNo, objectType: objectType}, "popupDialog", 'l', 525);
		}
	}

	function viewPrintDetail(requestNo, requestPurpose) {
// 		openDialogPopup('/general/production/requeststatus/printApprovalPopup', {requestNo : requestNo}, 'popupDialog', 'l', '550');
		openDialogPopup("/general/production/approval/printApprovalPopup", {requestNo: requestNo, requestPurpose: requestPurpose}, "popupDialog", 'l', 530);
	}
	...
	function batchCall(saveType){
		...
		callAjax( param, "/general/production/approval/batchSaveApproval", batchCallback, 'json');
	}
