...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/views/general/production/disposalApproval/disposalApprovalPopup.js"></script>
<!-- 폐기 승인 팝업(폐기승인/반려 버튼)-->
<script>
	$(function() {
	});
