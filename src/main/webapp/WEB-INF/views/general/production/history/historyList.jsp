...
<script>
	function setGridParam(){
		gridParam = {
				...
				url : '/general/production/history/selectList',
...
// 		if(rowdata[''])
	...
	function viewDetail(requestNo){
		openDialogPopup("/general/production/history/historyDetailPopup", {requestNo: requestNo}, "popupDialog", 'l', 745);
	}


// 	function exportExcel(){
// 		openDialogPopup("/general/production/history/historyDetail2Popup"
// 				, {}
// 				, "popupDialog", 'l', 800);
// 	}
</script>
