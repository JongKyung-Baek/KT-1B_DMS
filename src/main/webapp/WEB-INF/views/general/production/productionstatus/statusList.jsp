...
var formId = 'formProductionStatus';
	...
	function setGridParam(){
		gridParam = {
				gridId : gridId,
				formId : formId,
				url : '/general/production/productionstatus/selectList',
	...
	function request(){
		...
		openDialogPopup('/general/production/productionstatus/requestPopup', {}, 'popupDialog', 'xl', '600');
	}
	...
	function viewDetail(objectNo, objectType){
		openDialogPopup("/general/production/productionstatus/distributionHistoryPopup", {objectNo: objectNo, objectType: objectType}, "popupDialog", 'l', 535);
	}
