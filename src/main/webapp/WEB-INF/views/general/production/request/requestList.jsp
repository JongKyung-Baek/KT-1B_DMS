...
var gridId = 'gridProductionRequestList';
	function setGridParam(){
		gridParam = {
				...
				url : '/general/production/request/selectList',
	...
	function request(){
		...
		openDialogPopup('/general/production/request/requestPopup', {}, 'popupDialog', 'l', popupHeight, true, 'popup-common popup-request');
	}
	...
	function printRequest(){
		...
		openDialogPopup('/general/production/request/printRequestPopup', {}, 'popupDialog', 's', popupHeight);
	}
	...
	function changeObjectClass(){
		...
		callAjax(param, "/general/production/request/selectObjectClassCd", setObjectClassCd);
	}
