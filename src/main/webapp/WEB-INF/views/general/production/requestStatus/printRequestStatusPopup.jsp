...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/views/general/production/requeststatus/printRequestStatusPopup.js"></script>
...
<form id="formPrintApprovalPopup">
	...
	<input id="actionCd" name="actionCd" value="${data.actionCd }" type="hidden"/>
	<ul class="section">
		<li class="half">
			<%-- 요청사유 --%>
			...
			<%-- 반려사유  --%>
			<custom:popupInputTextArea name="rejectDesc" label="form.printRejectDesc" rows="2" value="${data.rejectDesc }" id="rejectDesc" disabled="Y"/>
		</li>
	</ul>
</form>
	<div class="section">
...
<!-- 			<div class="right"> -->
<%-- 				<button class="ui-button ui-corner-all" onclick="openPrint('PRINT', 'gridPrintApprovalPopup', 'IN')"><spring:message code="btn.print"/></button> --%>
<!-- 			</div> -->
		</div>
