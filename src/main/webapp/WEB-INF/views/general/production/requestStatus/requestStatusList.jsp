...
<script>
	function setGridParam(){
		gridParam = {
				...
				url : '/general/production/requeststatus/selectList',
...
// 			return '<a href="javascript: viewDetail(\'' + cellValue + '\', \'' + rowdata['objectType'] +'\')">' + cellValue + '</a>';
	...
	function viewDetail(requestNo, objectType, deployTypeCd) {
		if(deployTypeCd === 'PRINT') {
			openDialogPopup('/general/production/requeststatus/printRequestStatusPopup', {requestNo : requestNo, objectType: objectType}, 'popupDialog', 'l', '520');
		} else {
			openDialogPopup('/general/production/requeststatus/requestStatusPopup', {requestNo : requestNo, objectType: objectType}, 'popupDialog', 'l', '750');
		}
	}
	...
	function printApproval() {
		...
		if($("#"+gridParam.gridId).getGridParam('selarrrow').length > 1){
			...
			openDialogPopup('/general/production/requeststatus/printApprovalPopup', {requestNo : requestNo}, 'popupDialog', 'l', '540');
		}
