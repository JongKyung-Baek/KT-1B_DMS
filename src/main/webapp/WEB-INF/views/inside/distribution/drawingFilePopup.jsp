		...
		<script>
			...
			function loadApprovalStatus() {
				...
				callAjax(
					...
					"/inside/distribution/drawingRequest/approveStatusRows",
					function (response) {
			...
			function saveApprovalComment(gridId, rowId) {
				...
				callAjax(
					...
					"/inside/distribution/drawingRequest/saveApprovalComment",
					function (response) {
			...
			function downloadSelectedDrawingFile(gridId) {
				...
				for (var i = 0; i < selectedRows.length; i++) {
					...
					var url = "/inside/distribution/drawingRequest/downloadFile?objectId=" + encodeURIComponent(data.objectId);
