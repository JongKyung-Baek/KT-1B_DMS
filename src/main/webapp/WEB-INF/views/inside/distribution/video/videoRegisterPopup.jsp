...
<script type="text/javascript" src="/resources/js/views/inside/distribution/video/videoRegisterPopup.js"></script>
...
<script>
    ...
    function isValidationX(){
        ...
        var fileInput = document.getElementById("videoRegisFile");
    ...
    function saveX() {
        ...
        callAjaxUpload(  formData, "/inside/distribution/videoRequest/uploadVideoRegisFile", requestCrXCallback);
    }
...
//	console.log("param.filePath : ", param.filePath)
    ...
    $(document).ready(function(){
        $('#videoRegisFile').change(function(){
...
<div class="dialogContent">
    <form id="formVideoRegisterPopup">
        <ul class="section">
        ...
        <li class="singleFileUpload">
            ...
            <div>
                <form id="fileForm" name="fileForm" enctype="multipart/form-data">
                    <input type="file" id="videoRegisFile" name="videoRegisFile" onchange="fileChange()" style="display: none;" />
                </form>
