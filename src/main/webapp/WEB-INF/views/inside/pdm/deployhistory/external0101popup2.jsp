...
<script>
	$(function() {
		$("#jqGridD1").jqGrid({
			datatype: "local",
			colNames:['도면번호','사업구분','도면명','REV','최종수정일','현재페이지','총페이지','방산기술보호대상'],
			colModel:[
				...
				{name:'col8', index:'col8', width: "130"},
			],
			width : null,
			height : null,
			autoheight : true,
		...
		var mydata = [
			{col1:"87654321",col2:"",col3:"덥개",col4:"A",col5:"2019-01-01",col6:"1",col7:"1",col8:"Y"},
			{col1:"87654321",col2:"",col3:"덥개",col4:"A",col5:"2019-01-01",col6:"1",col7:"1",col8:"N"},
			{col1:"87654321",col2:"",col3:"덥개",col4:"A",col5:"2019-01-01",col6:"1",col7:"1",col8:"N"},
			{col1:"87654321",col2:"",col3:"덥개",col4:"A",col5:"2019-01-01",col6:"1",col7:"1",col8:"N"},
			{col1:"87654321",col2:"",col3:"덥개",col4:"A",col5:"2019-01-01",col6:"1",col7:"1",col8:"N"},
			];
...
<div class="dialogContent">
	<ul class="section">
		...
		<li class="half">
			<label for="">사업장</label>
			<div><select id="" disabled><option>마곡</option></select></div>
		</li>
		<li class="half">
