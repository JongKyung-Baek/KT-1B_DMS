...
<title>배포 승인현황 - 도면 - CollabHub</title>
<script>
	...
	function openDialog1() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"external0102popup1"}, "popupDialog1", 's', 500);
	}
	function openDialog2() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"external0102popup2"}, "popupDialog2", 's', 330);
	}
</script>
<script>
	$(document).ready(function(){
		...
		var mydata = [
			{col1:"양산",col2:"VIEWING",col3:"42354",col4:"23452",col5:"조립도",col6:"ASFE.PLT",col7:"A",col8:"4",col9:"5",col10:"검토용",col11:"김구매",col12:"2019-01-01",col13:"2019-01-01",col14:"2019-01-01",col15:"6701",col16:"",col17:"폐기중",col18:"<a onclick='openDialog2()'>1건</a>"},
			];
...
<body>
	...
	<div class="btnArea">
		...
		<div class="right">
			...
			<button class="ui-button ui-corner-all" onclick="openDialog1()">파일다운</button>
		</div>
	</div>
