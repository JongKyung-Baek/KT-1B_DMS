...
<script>
	...
	function openDialog1() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"external0201popup1"}, "popupDialog1", 'm', 520);
	}
	function openDialog2() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"external0201popup2"}, "popupDialog2", 'm', 500);
	}
</script>
<script>
	$(document).ready(function(){
		$("#jqGrid").jqGrid({
			datatype: "local",
			colNames:['요청번호','대표문서번호','대표문서명','대표REV','용도','업체담당자','구매담당자','요청일','승인일','진행상태'],
			colModel:[
