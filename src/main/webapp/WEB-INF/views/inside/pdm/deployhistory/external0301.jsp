...
<title>배포요청 - S/W - CollabHub</title>
<script>
	...
	function openDialog1() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"external0301popup1"}, "popupDialog1", 'm', 520);
	}
	function openDialog2() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"external0301popup2"}, "popupDialog2", 'm', 500);
	}
</script>
<script>
	$(document).ready(function(){
		$("#jqGrid").jqGrid({
			datatype: "local",
			colNames:['요청번호','대표SW번호','대표SW명','대표REV','용도','업체담당자','구매담당자','요청일','승인일','진행상태'],
			colModel:[
		...
		var mydata = [
			{col1:"<a onclick='openDialog2()'>20161233-D0014</a>",col2:"A200011234",col3:"좌측덥개",col4:"0",col5:"참고용",col6:"이왕근",col7:"김구매",col8:"2019-01-01",col9:"2019-01-01",col10:"임시저장"},
			{col1:"<a onclick='openDialog2()'>20161233-D0014</a>",col2:"A200011234",col3:"좌측덥개",col4:"0",col5:"참고용",col6:"이왕근",col7:"김구매",col8:"2019-01-01",col9:"2019-01-01",col10:"승인"},
			];
...
<body>
	<div class="sbr">
		<ul class="ibx">
			...
			<li>
				<label for="input2">문서번호</label>
				<input type="text" name="" id="input2">
			</li>
			<li>
				<label for="input3">문서명</label>
	...
	<div id="popupDialog" class="dialogContainer"></div> <!-- 배포요청 버튼 -->
