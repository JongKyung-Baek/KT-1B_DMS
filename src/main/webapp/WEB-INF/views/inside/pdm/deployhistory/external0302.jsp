...
<title>배포 승인현황 - S/W - CollabHub</title>
<script>
	...
	function openDialog1() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"external0302popup1"}, "popupDialog1", 's', 500);
	}
	function openDialog2() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"external0302popup2"}, "popupDialog2", 's', 330);
	}
</script>
<script>
	$(document).ready(function(){
		$("#jqGrid").jqGrid({
			datatype: "local",
			colNames:['사업구분','배포유형','승인번호','SW번호','SW명','파일명','REV','용도','구매담당자','유효기간','요청일','승인일','기종','방산기술','폐기구분','첨부파일'],
			colModel:[
...
<body>
	<div class="sbr">
		<ul class="ibx">
			...
			<li>
				<label for="input1">SW번호</label>
				<input type="text" name="" id="input1">
			</li>
			<li>
				<label for="input2">SW명</label>
