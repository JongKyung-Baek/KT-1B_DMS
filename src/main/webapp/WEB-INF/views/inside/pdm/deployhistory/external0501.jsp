...
<title>미등록자료 배포현황 - 미등록자료 - CollabHub</title>
<script>
	...
	function openDialog() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"external0501popup"}, "popupDialog", 'm', 600);
	}
</script>
<script>
	$(document).ready(function(){
		$("#jqGrid").jqGrid({
			datatype: "local",
			colNames:['요청번호','자료유형','자료명','요청자','요청일','배포방식','파일명','승인자','승인일','업체명','유효기간','상태','구매담당자'],
			colModel:[
				...
				{name:'col11', index:'col11', width:'100'},
		...
		var mydata = [
			{col1:"1234",col2:"도면",col3:"제조용",col4:"홍길동",col5:"2019-01-01",col6:"Viewing",col7:"VT11",col8:"홍길동",col9:"2019-01-01",col10:"",col11:"2019-01-01",col12:"",col13:""},
			{col1:"1234",col2:"도면",col3:"제조용",col4:"홍길동",col5:"2019-01-01",col6:"Viewing",col7:"VT11",col8:"홍길동",col9:"2019-01-01",col10:"",col11:"2019-01-01",col12:"",col13:""},
			{col1:"1234",col2:"문서",col3:"제조용",col4:"홍길동",col5:"2019-01-01",col6:"일반영역",col7:"VT11",col8:"홍길동",col9:"2019-01-01",col10:"",col11:"2019-01-01",col12:"",col13:""},
			{col1:"1234",col2:"도면",col3:"제조용",col4:"홍길동",col5:"2019-01-01",col6:"보안영역",col7:"VT11",col8:"홍길동",col9:"2019-01-01",col10:"",col11:"2019-01-01",col12:"",col13:""},
			{col1:"1234",col2:"문서",col3:"제조용",col4:"홍길동",col5:"2019-01-01",col6:"일반영역",col7:"VT11",col8:"홍길동",col9:"2019-01-01",col10:"",col11:"2019-01-01",col12:"",col13:""},
			];
...
<body>
	<div class="sbr">
		<ul class="ibx">
			...
			<li>
				<label for="">사업장</label>
				<select id=""><option>마곡</option></select>
			</li>
		</ul>
		<div class="btnBox">
	...
	<div id="popupDialog" class="dialogContainer"></div> <!-- 파일다운 버튼 -->
</body>
</html>