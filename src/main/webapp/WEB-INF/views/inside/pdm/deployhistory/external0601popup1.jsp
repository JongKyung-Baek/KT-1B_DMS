...
<div class="dialogContent">
	<ul class="section">
		...
		<li>
			...
			<input type="checkbox" name="checkbox" id="input11">
		</li>
		<li>
			<label for="">요청 구분</label>
			<div>
				<label for="input12">신규</label><input type="radio" name="inputcheck" id="input12">
				<label for="input13">변경</label><input type="radio" name="inputcheck" id="input13">
				<label for="input14">삭제</label><input type="radio" name="inputcheck" id="input14">
			</div>
		</li>
		<li>
