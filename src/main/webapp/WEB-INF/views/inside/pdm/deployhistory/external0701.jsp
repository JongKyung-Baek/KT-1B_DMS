...
<script>
	...
	function openDialog() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"external0701popup"}, "popupDialog", 'm', 480);
	}
</script>
<script>
	$(document).ready(function(){
		...
		var mydata = [
			{col1:"<a onclick='openDialog()'>[공지] 외부사용자 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"1"},
			{col1:"<a onclick='openDialog()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"2"},
			{col1:"<a onclick='openDialog()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"3"},
			{col1:"<a onclick='openDialog()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"4"},
			{col1:"<a onclick='openDialog()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"5"},
			{col1:"<a onclick='openDialog()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"6"},
			{col1:"<a onclick='openDialog()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"7"},
			{col1:"<a onclick='openDialog()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"8"},
			{col1:"<a onclick='openDialog()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"9"},
			{col1:"<a onclick='openDialog()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"10"},
			{col1:"<a onclick='openDialog()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"11"},
		];
...
<body>
	...
	<div id="popupDialog" class="dialogContainer"></div> <!-- 제목 상세보기 -->
</body>
</html>