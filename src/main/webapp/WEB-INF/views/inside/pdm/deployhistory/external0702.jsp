...
<script>
	...
	function openDialog1() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"external0702popup1"}, "popupDialog1", 'm', 480);
	}
	function openDialog2() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"external0702popup2"}, "popupDialog2", 'm', 480);
	}
</script>
<script>
	$(document).ready(function(){
		...
		var mydata = [
			{col1:"<a onclick='openDialog1()'>외부사용자 배포도면 출력불가문의</a>",col2:"이왕근",col3:"2019-01-01",col4:"1"},
			{col1:"<a onclick='openDialog2()' class='gridReply'>배포도면 출력불가문의</a>",col2:"이왕근",col3:"2019-01-01",col4:"2"},
			{col1:"<a onclick='openDialog1()'>배포도면 출력불가문의</a>",col2:"이왕근",col3:"2019-01-01",col4:"1"},
...
<body>
	...
	<div id="popupDialog2" class="dialogContainer"></div> <!-- 제목 상세보기 -->
</body>
</html>