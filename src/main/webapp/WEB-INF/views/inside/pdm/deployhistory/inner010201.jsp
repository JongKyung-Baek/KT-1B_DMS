...
<title>도면 - 검색 및 배포요청 - CollabHub</title>
<script>
	...
	function openDialog1() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner010201popup1"}, "popupDialog1", 'm', 450);
	}
	function openDialog2() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner010201popup2"}, "popupDialog2", 'm', 380);
	}
...
<script>
	$(document).ready(function(){
		$("#jqGrid").jqGrid({
			datatype: "local",
			colNames:['사업구분','배포유형','도번','도명','REV','페이지','총페이지','파일명','등록자','등록팀','등록일','규격화승인일','기술변경승인일','CO번호','업체명','구매담당자','기종','사업장','방산기술'],
			colModel:[
		...
		var mydata = [
			{col1:"개발",col2:"원도",col3:"FOE21056",col4:"하우징",col5:"A",col6:"3",col7:"3",col8:"LL54",col9:"홍길동",col10:"발사체계3팀",col11:"2019-04-11",col12:"",col13:"",col14:"",col15:"",col16:"",col17:"LL54",col18:"1사업장",col19:"Y"},
			{col1:"양산",col2:"승인요청도",col3:"FOE21056",col4:"하우징",col5:"A",col6:"3",col7:"3",col8:"LL54",col9:"홍길동",col10:"발사체계3팀",col11:"2019-04-11",col12:"",col13:"",col14:"",col15:"",col16:"",col17:"LL54",col18:"1사업장",col19:"Y"},
			{col1:"양산",col2:"승인도",col3:"FOE21056",col4:"하우징",col5:"A",col6:"3",col7:"3",col8:"LL54",col9:"홍길동",col10:"발사체계3팀",col11:"2019-04-11",col12:"",col13:"",col14:"",col15:"",col16:"",col17:"LL54",col18:"1사업장",col19:"Y"},
			{col1:"개발",col2:"긴급도",col3:"FOE21056",col4:"하우징",col5:"A",col6:"3",col7:"3",col8:"LL54",col9:"홍길동",col10:"발사체계3팀",col11:"2019-04-11",col12:"",col13:"",col14:"",col15:"",col16:"",col17:"LL54",col18:"1사업장",col19:"Y"},
			];
	...
	<div class="sbr">
		<ul class="ibx">
			...
			<li>
				...
				<label for="input11">Vendor</label>
			</li>
			<li>
