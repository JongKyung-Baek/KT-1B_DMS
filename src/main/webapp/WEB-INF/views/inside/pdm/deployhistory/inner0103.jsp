...
<title>배포요청현황 - 자료배포 - CollabHub</title>
<script>
	...
	function openDialog() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0103popup"}, "popupDialog", 'l', 520);
	}
</script>
<script>
	$(document).ready(function(){
		$("#jqGrid").jqGrid({
			datatype: "local",
			colNames:['자료유형','요청번호','배포업체','배포방식','용도','요청자','요청일','유효기간','구매담당자','사업장','팀장승인','방산기술승인','방산기술여부'],
			colModel:[
		...
		var mydata = [
			{col1:"도면",col2:"<a onclick='openDialog()'>A9827345</a>",col3:"지성",col4:"Viewing",col5:"참고용",col6:"이길동",col7:"",col8:"",col9:"",col10:"1사업장",col11:"승인",col12:"승인",col13:"Y"},
			{col1:"문서",col2:"<a onclick='openDialog()'>A9827345</a>",col3:"흥일기업",col4:"일반영역",col5:"견적용",col6:"김길동",col7:"",col8:"",col9:"",col10:"2사업장",col11:"승인",col12:"",col13:"N"},
			{col1:"SW",col2:"<a onclick='openDialog()'>A9827345</a>",col3:"지성",col4:"보안영역",col5:"검토용",col6:"박길동",col7:"",col8:"",col9:"",col10:"1사업장",col11:"승인",col12:"",col13:"N"}
			];
