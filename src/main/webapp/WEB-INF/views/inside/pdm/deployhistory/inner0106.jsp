...
<script>
	...
	function openDialog() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0106popup"}, "popupDialog", 'l', 520);
	}
</script>
<script>
	$(document).ready(function(){
		$("#jqGrid").jqGrid({
			datatype: "local",
			colNames:['자료유형','출력요청번호','용도','출력요청자','요청일','출력폐기기한','사업장'],
			colModel:[
		...
		var mydata = [
			{col1:"도면",col2:"<a onclick='openDialog()'>A9827345</a>",col3:"참고용",col4:"이길동",col5:"",col6:"",col7:"1사업장"},
			{col1:"문서",col2:"<a onclick='openDialog()'>A9827345</a>",col3:"견적용",col4:"김길동",col5:"",col6:"",col7:"2사업장"},
			{col1:"SW",col2:"<a onclick='openDialog()'>A9827345</a>",col3:"검토용",col4:"박길동",col5:"",col6:"",col7:"1사업장"}
			];
...
<body>
	...
	<div class="btnArea">
		<div class="left">
			...
			<span class="textCaution">출력횟수 : 3회 , 출력유효기한 : 팀장 승인 후 1주일</span>
		</div>
		<div class="right">
			<!-- <button class="ui-button ui-corner-all">일괄출력승인</button>
			<button class="ui-button ui-corner-all">일괄출력반려</button>  -->
		</div>
	</div>
	...
	<div id="popupDialog" class="dialogContainer"></div> <!-- 출력요청번호 상세보기 -->
</body>
</html>