...
<title>출력물 폐기승인 - CollabHub</title>
<script>
	...
	function openDialog() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0108popup"}, "popupDialog", 'l', 520);
	}
</script>
<script>
	$(document).ready(function(){
		$("#jqGrid").jqGrid({
			datatype: "local",
			colNames:['자료유형','요청번호','용도','요청자','요청일','출력폐기기한','사업장'],
			colModel:[
...
<body>
	...
	<div class="btnArea">
		...
		<div class="right">
			<!--  <button class="ui-button ui-corner-all">일괄폐기승인</button>
			<button class="ui-button ui-corner-all">일괄폐기반려</button> -->
		</div>
	</div>
