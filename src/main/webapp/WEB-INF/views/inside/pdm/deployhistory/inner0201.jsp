...
<title>CR 접수 - CR - CollabHub</title>
<script>
	...
	function openDialog() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0201popup"}, "popupDialog", 'm', 600);
	}
</script>
<script>
	$(document).ready(function(){
		$("#jqGrid").jqGrid({
			datatype: "local",
			colNames:['제의번호','도번','제목','제의사유','구매담당자','요청일','요청업체','승인일','진행상태','사업장','기종'],
			colModel:[
		...
		var mydata = [
			{col1:"<a onclick='openDialog()'>1906-R002</a>",col2:"A70013323",col3:"도면 오기 기술변경",col4:"도면오기",col5:"김구매",col6:"",col7:"",col8:"",col9:"미처리",col10:"1사업장",col11:""},
			{col1:"<a onclick='openDialog()'>1906-R002</a>",col2:"A70013323",col3:"도면 오기 기술변경",col4:"도면오기",col5:"김구매",col6:"",col7:"",col8:"",col9:"미처리",col10:"1사업장",col11:""},
			{col1:"<a onclick='openDialog()'>1906-R002</a>",col2:"A70013323",col3:"도면 오기 기술변경",col4:"도면오기",col5:"김구매",col6:"",col7:"",col8:"",col9:"미처리",col10:"1사업장",col11:""}
			];
