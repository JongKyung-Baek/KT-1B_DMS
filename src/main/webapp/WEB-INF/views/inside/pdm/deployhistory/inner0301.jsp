...
<title>등록 및 배포요청 - 미등록자료 배포 - CollabHub</title>
<script>
	...
	function openDialog1() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0301popup1"}, "popupDialog1", 'm', 450);
	}
	function openDialog2() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0301popup2"}, "popupDialog2", 'm', 450);
	}
</script>
<script>
	$(document).ready(function(){
		$("#jqGrid").jqGrid({
			datatype: "local",
			colNames:['상태','자료번호','자료명','파일명','등록자','등록일','구매담당자','사업장'],
			colModel:[
		...
		var mydata = [
			{col1:"결재요청",col2:"123412-00001",col3:"설명서 자료",col4:"TDP.TIF",col5:"홍길동",col6:"2019-01-01",col7:"",col8:"1사업장"},
			{col1:"결재요청",col2:"123412-00001",col3:"설명서 자료",col4:"TDP.TIF",col5:"홍길동",col6:"2019-01-01",col7:"",col8:"1사업장"},
			{col1:"결재요청",col2:"123412-00001",col3:"설명서 자료",col4:"TDP.TIF",col5:"홍길동",col6:"2019-01-01",col7:"",col8:"1사업장"},
			{col1:"결재요청",col2:"123412-00001",col3:"설명서 자료",col4:"TDP.TIF",col5:"홍길동",col6:"2019-01-01",col7:"",col8:"1사업장"},
			];
...
<body>
	...
	<div class="btnArea">
		...
		<div class="right">
			...
			<button class="ui-button ui-corner-all" onclick="openDialog1()">미등록자료 등록 버튼</button>
			<button class="ui-button ui-corner-all" onclick="openDialog2()">자료배포 버튼</button>
		</div>
	</div>
	...
	<div id="popupDialog1" class="dialogContainer"></div> <!-- 미등록자료 등록 버튼 -->
	<div id="popupDialog2" class="dialogContainer"></div> <!-- 자료배포 버튼 -->
</body>
</html>
