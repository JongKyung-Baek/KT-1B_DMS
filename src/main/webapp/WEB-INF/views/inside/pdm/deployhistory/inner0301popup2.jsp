...
<div class="dialogContent">
	<ul class="section">
		<li class="half">
			<label for="">업체</label>
			<div><select id=""><option value="">선택하세요</option></select></div>
		...
		<li class="half">
			...
			<div><select id="" disabled><option selected>이길동</option></select></div>
		</li>
		<li class="half">
			<label for="">결재자</label>
	...
	<ul class="section">
		...
		<li class="half">
			...
			<div><select id=""><option value="" selected>선택하세요</option><option>1개월</option></select></div>
		</li>
		<li>
			<label for="">배포요청사유</label>
