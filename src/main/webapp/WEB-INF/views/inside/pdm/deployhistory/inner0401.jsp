...
<title>검색 및 배포요청 - 생산기술자료 - CollabHub</title>
<script>
	...
	function openDialog1() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0401popup1"}, "popupDialog1", 'l', 600);
	}
	function openDialog2() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0401popup2"}, "popupDialog2", 's', 380);
	}
</script>
<script>
	$(document).ready(function(){
		$("#jqGrid").jqGrid({
			datatype: "local",
			colNames:['사업구분','자료번호','REV','자료명','자료유형','등록자','등록일','수정자','수정일','총매수','파일명','파일경로','기종','Call ID','호기','보안등급'],
			colModel:[
		...
		var mydata = [
			{col1:"개발",col2:"XXXXXXX",col3:"A",col4:"XXXXXXXX",col5:"조립공정서",col6:"XXX",col7:"2019-01-01",col8:"홍길동",col9:"2019-01-01",col10:"",col11:"",col12:"",col13:"",col14:"",col15:"",col16:""},
			{col1:"개발",col2:"XXXXXXX",col3:"A",col4:"XXXXXXXX",col5:"조립공정서",col6:"XXX",col7:"2019-01-01",col8:"홍길동",col9:"2019-01-01",col10:"",col11:"",col12:"",col13:"",col14:"",col15:"",col16:""},
			{col1:"개발",col2:"XXXXXXX",col3:"A",col4:"XXXXXXXX",col5:"조립공정서",col6:"XXX",col7:"2019-01-01",col8:"홍길동",col9:"2019-01-01",col10:"",col11:"",col12:"",col13:"",col14:"",col15:"",col16:""},
			];
...
<body>
	<div class="sbr">
		<ul class="ibx">
			...
			<li>
				<input type="checkbox" name="input" id="input11">
	...
	<div class="btnArea">
		<div class="left">
			...
			<button class="ui-button ui-corner-all" onclick="openDialog2()">일괄검색</button>
		</div>
		<div class="right">
			<button class="ui-button ui-corner-all">Viewing</button>
			<button class="ui-button ui-corner-all" onclick="openDialog1()">생산기술자료 배포 승인요청</button>
		</div>
	</div>
	...
	<div id="popupDialog1" class="dialogContainer"></div> <!-- 생산기술자료 배포 승인요청 버튼 -->
	<div id="popupDialog2" class="dialogContainer"></div> <!-- 일괄검색 버튼 -->
</body>
</html>