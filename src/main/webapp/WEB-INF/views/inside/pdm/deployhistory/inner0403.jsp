...
<title>현장관리자 접수 - 생산기술자료 - CollabHub</title>
<script>
	...
	function openDialog() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0403popup"}, "popupDialog", 'l', 520);
	}
</script>
<script>
	$(document).ready(function(){
		$("#jqGrid").jqGrid({
			datatype: "local",
			colNames:['요청번호','자료유형','배포유형','기종','호기','문서번호','자료번호','REV','문서명','배포매수','폐기예정','배포자','접수자','배포일자','사업장'],
			colModel:[
		...
		var mydata = [
			{col1:"1903-001",col2:"용접공정서",col3:"신규",col4:"XK56",col5:"",col6:"",col7:"K56W090",col8:"0",col9:"Cargo-1",col10:"20",col11:"",col12:"김길동",col13:"홍길동",col14:"2019-01-01",col15:"1사업장"},
			{col1:"1903-001",col2:"용접공정서",col3:"기존대체",col4:"XK56",col5:"",col6:"",col7:"K56W09",col8:"A",col9:"Cargo-1",col10:"25",col11:"23",col12:"이길동",col13:"강길동",col14:"2019-01-01",col15:"2사업장"},
			{col1:"1903-001",col2:"용접공정서",col3:"신규",col4:"XK56",col5:"",col6:"",col7:"K56W090",col8:"0",col9:"Cargo-1",col10:"20",col11:"",col12:"김길동",col13:"홍길동",col14:"2019-01-01",col15:"1사업장"},
			{col1:"1903-001",col2:"용접공정서",col3:"신규",col4:"XK56",col5:"",col6:"",col7:"K56W090",col8:"0",col9:"Cargo-1",col10:"20",col11:"",col12:"김길동",col13:"홍길동",col14:"2019-01-01",col15:"1사업장"},
			];
...
<body>
	...
	<div class="btnArea">
		...
		<div class="right">
			...
			<button class="ui-button ui-corner-all" onclick="openDialog()">접수</button>
		</div>
	</div>
	...
	<div id="popupDialog" class="dialogContainer"></div> <!-- 접수 버튼 -->
</body>
</html>