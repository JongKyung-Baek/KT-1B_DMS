...
<title>현황 및 폐기 - 생산기술자료 - CollabHub</title>
<script>
	...
	function openDialog() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0404popup"}, "popupDialog", 's', 280);
	}
</script>
<script>
	$(document).ready(function(){
		$("#jqGrid").jqGrid({
			datatype: "local",
			colNames:['요청번호','자료유형','배포유형','기종','호기','문서번호','자료번호','REV','보유매수','사업장','부서','접수자','접수일','배포자','배포일'],
			colModel:[
		...
		var mydata = [
			{col1:"1903-001",col2:"용접공정서",col3:"신규",col4:"XK56",col5:"",col6:"",col7:"K56W090",col8:"0",col9:"20",col10:"1사업장",col11:"용접직",col12:"김길동",col13:"2019-01-01",col14:"홍길동",col15:"2019-01-01"},
			{col1:"1903-001",col2:"용접공정서",col3:"기존대체",col4:"XK56",col5:"",col6:"",col7:"K56W090",col8:"A",col9:"25",col10:"2사업장",col11:"가공직",col12:"김길동",col13:"2019-01-01",col14:"홍길동",col15:"2019-01-01"},
			{col1:"1903-001",col2:"용접공정서",col3:"신규",col4:"XK56",col5:"",col6:"",col7:"K56W090",col8:"0",col9:"20",col10:"2사업장",col11:"가공직",col12:"김길동",col13:"2019-01-01",col14:"홍길동",col15:"2019-01-01"},
		];
...
<body>
	...
	<div class="btnArea">
		...
		<div class="right">
			...
			<button class="ui-button ui-corner-all" onclick="openDialog()">전체폐기</button>
		</div>
	</div>
	...
	<div id="popupDialog" class="dialogContainer"></div> <!-- 전체폐기 버튼 -->
</body>
</html>