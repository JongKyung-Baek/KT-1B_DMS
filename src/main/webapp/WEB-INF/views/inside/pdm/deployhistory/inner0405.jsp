...
<title>폐기 승인 - 생산기술자료 - CollabHub</title>
<script>
	...
	function openDialog() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0405popup"}, "popupDialog", 's', 320);
	}
</script>
<script>
	$(document).ready(function(){
...
<body>
	...
	<div class="btnArea">
		...
		<div class="right">
			...
			<button class="ui-button ui-corner-all" onclick="openDialog()">폐기승인/반려</button>
		</div>
	</div>
	...
	<div id="popupDialog" class="dialogContainer"></div> <!-- 폐기승인/반려 버튼 -->
</body>
</html>