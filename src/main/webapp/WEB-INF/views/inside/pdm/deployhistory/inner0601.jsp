...
<script>
	...
	function openDialog1() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0601popup1"}, "popupDialog1", 'm', 470);
	}
	function openDialog2() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0601popup2"}, "popupDialog2", 'm', 470);
	}
</script>
<script>
	$(document).ready(function(){
		...
		var mydata = [
			{col1:"<a onclick='openDialog2()'>[공지] 내부사용자 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"1"},
			{col1:"<a onclick='openDialog2()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"2"},
			{col1:"<a onclick='openDialog2()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"3"},
			{col1:"<a onclick='openDialog2()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"4"},
			{col1:"<a onclick='openDialog2()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"5"},
			{col1:"<a onclick='openDialog2()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"6"},
			{col1:"<a onclick='openDialog2()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"7"},
			{col1:"<a onclick='openDialog2()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"8"},
			{col1:"<a onclick='openDialog2()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"9"},
			{col1:"<a onclick='openDialog2()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"10"},
			{col1:"<a onclick='openDialog2()'>[공지] 도면배포시스템 기능 추가 및 개선 내용</a>",col2:"이왕근",col3:"2019-01-01",col4:"11"},
		];
