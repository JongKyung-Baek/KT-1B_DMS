...
<script>
	...
	function openDialog1() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0701popup1"}, "popupDialog1", 'm', 320);
	}
	function openDialog2() {
		openDialogPopup("/inside/pdm/deployhistory/Popup", {url:"inner0701popup2"}, "popupDialog2", 'm', 320);
	}
</script>
<script>
	$(document).ready(function(){
...
<body>
	<div class="br">
		<div class="btnArea">
			<div class="left"></div>
			<div class="right">
				<button class="ui-button ui-corner-all" onclick="openDialog1()">그룹추가</button>
			</div>
		</div>
		<div class="listArea">
			<div class="listContainer">
				...
				<ul>
					...
					<li class="current"><span>구매팀</span><button type="button" class="ui-button detailBtn" onclick="openDialog2()"></button></li>
	...
	<div id="popupDialog1" class="dialogContainer"></div> <!-- 그룹 추가 버튼 -->
	<div id="popupDialog2" class="dialogContainer"></div> <!-- 그룹 상세보기 및 수정 버튼 -->
</body>
</html>
