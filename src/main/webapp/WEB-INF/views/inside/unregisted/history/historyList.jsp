...
<script>
	function setGridParam(){
		gridParam = {
				gridId : 'gridUnregistedHistoryList',
				formId : 'formUnregistedHistory',
				url : '/inside/unregisted/history/selectList',
...
<body>
	<custom:listTemplate gridId="gridUnregistedHistoryList"/>
</body>
</html>