...
<title><c:choose><c:when test="${tdmsBrand.alternate}"><c:out value="${tdmsBrand.systemName}" /> - Login</c:when><c:otherwise>TDMS - Login</c:otherwise></c:choose></title>
...
<main class="login-page">
    ...
    <spring:message code="feature.login.pageLabel" var="loginPageLabel"/>
    <c:if test="${tdmsBrand.alternate}">
      <c:set var="loginPageLabel" value="${tdmsBrand.systemName}" />
    </c:if>
    <section class="login-wrap" aria-label="${loginPageLabel}">
      <div class="brand-area">
        <div class="brand-box">
          <c:if test="${tdmsBrand.alternate}">
            <img class="alternate-brand-logo"
                 src="${pageContext.request.contextPath}${tdmsBrand.logoDarkPath}"
                 alt="${tdmsBrand.logoAlt}" />
            <div class="alternate-system-name"><c:out value="${tdmsBrand.systemName}" /></div>
            <div class="alternate-company-name"><c:out value="${tdmsBrand.companyName}" /></div>
          </c:if>
          <c:if test="${not tdmsBrand.alternate}">
