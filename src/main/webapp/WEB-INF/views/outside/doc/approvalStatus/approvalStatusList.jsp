...
var g_gridId = "gridOutsideDocApprovalStatusList";
var g_formId = 'formOutsideDocApprovalStatus';

		function viewDetail(lastDestroyRequestNo) {
			openDialogPopup("/outside/doc/approvalStatus/destroyStatusPopup"
	...
	function setGridParam(){
		gridParam = {
				gridId : g_gridId,
				formId : g_formId,
				url : '/outside/doc/approvalStatus/selectList',
	...
	function formatOpenView(cellValue, options, rowdata, action){
		return '<a onclick="openFile(\'DISTRIBUTION\', \'DOC\', \'' +rowdata["requestNo"] +'\', \'' + rowdata["objectId"] +'\', \'' + rowdata["fileNo"] + '\', \'' + rowdata["protectYn"] + '\')">'+cellValue+'</a>';
	}
...
<body>
	<div class="distribution-invoice-page">
		<custom:listTemplateInvoice gridId="gridOutsideDocApprovalStatusList"/>
	</div>
</body>
</html>
