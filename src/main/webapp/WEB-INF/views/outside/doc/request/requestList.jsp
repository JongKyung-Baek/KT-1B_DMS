...
<script>
	window.USE_ACCEPTANCE_VUEXY_FORM = true;
		...
		function openDialog() {
			openDialogPopup("/outside/doc/request/requestPopup",{}, "popupDialog", 'xl', 740, true, 'popup-common popup-request');
		}

	function setGridParam(){
		gridParam = {
				gridId : 'gridOutsideDocRequestList',
				formId : 'formOutsideDocRequest',
				url : '/outside/doc/request/selectList',
	...
	function viewDetail(requestNo){
		openDialogPopup("/outside/doc/request/requestStatusPopup"
				, {requestNo: requestNo}
...
<body>
	<div class="distribution-invoice-page">
		<custom:listTemplateInvoice gridId="gridOutsideDocRequestList"/>
	</div>
</body>
</html>
