...
<script>
	...
	var g_gridId = "gridOutsideDrawingApprovalStatusList";
	var g_formId = 'formOutsideDrawingApprovalStatus';

		function viewDetail(lastDestroyRequestNo) {
			openDialogPopup("/outside/drawing/approvalStatus/destroyStatusPopup"
	...
	function setGridParam(){
		gridParam = {
				gridId : g_gridId,
				formId : g_formId,
				url : '/outside/drawing/approvalStatus/selectList',
	...
	function formatOpenView(cellValue, options, rowdata, action){
		return '<a onclick="openFile(\'DISTRIBUTION\', \'DRAWING\', \'' +rowdata["requestNo"] +'\', \'' + rowdata["objectId"] +'\', \'' + rowdata["fileNo"] + '\', \'' + rowdata["protectYn"] + '\')">'+cellValue+'</a>';
	}
...
<body>
	<div class="distribution-invoice-page">
		<custom:listTemplateInvoice gridId="gridOutsideDrawingApprovalStatusList"/>
	</div>
</body>
</html>
