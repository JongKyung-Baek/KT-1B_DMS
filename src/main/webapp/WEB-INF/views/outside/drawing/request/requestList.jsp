...
<script>
	window.USE_ACCEPTANCE_VUEXY_FORM = true;
		...
		function openDialog() {
			openDialogPopup("/outside/drawing/request/requestPopup",{}, "popupDialog", 'xl', 740, true, 'popup-common popup-request');
		}

	function setGridParam(){
		gridParam = {
				gridId : 'gridOutsideDrawingRequestList',
				formId : 'formOutsideDrawingRequest',
				url : '/outside/drawing/request/selectList',
	...
	function viewDetail(requestNo){
		openDialogPopup("/outside/drawing/request/requestStatusPopup"
				, {requestNo: requestNo}
...
<body>
	<div class="distribution-invoice-page">
		<custom:listTemplateInvoice gridId="gridOutsideDrawingRequestList"/>
	</div>
</body>
</html>
