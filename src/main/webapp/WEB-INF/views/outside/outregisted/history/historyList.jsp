...
<script>
	function setGridParam(){
		gridParam = {
				gridId : 'gridOutregistedHistoryList',
				formId : 'formOutregistedHistory',
				url : '/outside/outregisted/history/selectList',
...
<body>
	<custom:listTemplate gridId="gridOutregistedHistoryList"/>
</body>
</html>