...
<script>
		window.USE_ACCEPTANCE_VUEXY_FORM = true;
			...
			function openDialog() {
				openDialogPopup("/outside/production/request/requestPopup",{}, "popupDialog", 'xl', 740, true, 'popup-common popup-request');
			}

		function setGridParam(){
			gridParam = {
					gridId : 'gridOutsideProductionRequestList',
					formId : 'formOutsideProductionRequest',
					url : '/outside/production/request/selectList',
	...
	function viewDetail(requestNo){
		openDialogPopup("/outside/production/request/requestStatusPopup"
				, {requestNo: requestNo}
...
<body>
		<div class="distribution-invoice-page">
			<custom:listTemplateInvoice gridId="gridOutsideProductionRequestList"/>
		</div>
</body>
</html>
