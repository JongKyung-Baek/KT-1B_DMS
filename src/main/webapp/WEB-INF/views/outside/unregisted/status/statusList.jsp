...
<script>
	function setGridParam(){
		gridParam = {
				gridId : 'gridOutsideUnregistedStatusList',
				formId : 'formOutsideUnregistedStatus',
				url : '/outside/unregisted/status/selectList',
...
<body>
	<custom:listTemplate gridId="gridOutsideUnregistedStatusList"/>
</body>
</html>
