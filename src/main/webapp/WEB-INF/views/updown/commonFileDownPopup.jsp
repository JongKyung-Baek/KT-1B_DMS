...
// 	$("#downloadActiveX")[0].ShowArray("0|a.jpg|a.jpg|29106|X:/FDMS/OUT/|31|2019-12-02");
	...
	callAjax(param, '/common/updown/selectList', callDownload, 'json');
});
...
<div class="dialogContent">
	...
	<%--             <PARAM NAME="downloadVolume"      VALUE="R">	일반영역: R, 보안영역: S --%>
	            	<PARAM NAME="downloadVolume"      VALUE="${downloadVolume }">	일반영역, 보안영역
	        	</OBJECT>
			</c:when>
			<c:otherwise>
				<OBJECT ID="downloadActiveX" CLASSID="CLSID:45356ABB-F3F3-48A2-9511-B11F72CF0069" CODEBASE="${config.updownCabUrlOut }" width="706" height="320">
	           		<PARAM NAME="downloadServerIp"    VALUE="${config.updownOutServerIp }">
	            	<PARAM NAME="downloadServerPort"  VALUE="${config.updownServerPort }">
	            	<PARAM NAME="downloadLangCode"    VALUE="${config.updownLangCode }">
	            	<PARAM NAME="downloadUserAuth"    VALUE="${config.updownUserAuth }">
	            	<PARAM NAME="downloadSecretKey"   VALUE="${config.updownSecretKey}">
