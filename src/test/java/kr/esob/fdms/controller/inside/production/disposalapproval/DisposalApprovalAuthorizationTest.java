...
class DisposalApprovalAuthorizationTest {
	...
	void transactionPostRouteAndSqlEnforceCurrentPendingActor() throws Exception {
		...
		String mapper = read(
				"src/main/resources/sqlMaps/oracle/its/controller/inside/production/disposalapproval/DisposalApproval.xml");
		...
		String creationMapper = read(
				"src/main/resources/sqlMaps/oracle/its/controller/inside/production/disposal/Disposal.xml");
