...
import kr.esob.tdms.controller.general.production.approval.ApprovalDao;
...
import kr.esob.tdms.controller.general.production.common.ProductStatusVO;
...
class AcceptanceAuthorizationTest {
	...
	void transactionsPostRouteAndSqlEnforceApprovedPendingActor() throws Exception {
		...
		String acceptanceMapper = read(
				"src/main/resources/sqlMaps/oracle/its/controller/general/production/acceptance/Acceptance.xml");
		...
		String approvalMapper = read(
				"src/main/resources/sqlMaps/oracle/its/controller/general/production/approval/Approval.xml");
